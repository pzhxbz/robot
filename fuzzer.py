...
class Fuzzer(object):
    ...
    def __init__(
        self, binary_path, work_dir, afl_path, afl_count=1, library_path=None, time_limit=None, memory="8G",
	    ...
	    pass
            ...
            self.afl_dir          = afl_path

            # the path to AFL capable of calling driller
            self.afl_path         = afl_path+'/afl-fuzz'

            if self.os == 'cgc':
                self.afl_path_var = afl_path
            else:
                self.afl_path_var = afl_path
                # set up libraries
